...
const questions = [
  {
    ...
    options: [
      {
        id: "A",
        text: "The State Of Registry Or Common Mark Registering Authority",
        isCorrect: true,
      },
    ...
    <>
      <section className="pt-5 bg-light">
        <div className="container">
          ...
          <h2 className="fw-bold text-center text-warning">Solar System</h2>
        </div>
      </section>
      <div className="container">
              ...
              <div className="question-box" key={q.id}>
                ...
                {selected && (
                  <div className="answer-box">
                    ...
                    <a href="#" className="help-link text-end">
                      Help?
                    </a>
                  </div>
                )}
